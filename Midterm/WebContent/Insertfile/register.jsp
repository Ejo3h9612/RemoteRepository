...
<body onLoad="setFocusToUserId()" >
     ...
     <TR height="60" >
         ...
         <TR>
             ...
             <TD width="230"  align="center">
                 <Font color="#006600" size='4' face="標楷體">職業災禍人數登記</Font>
             </TD>
  ...
  <form ENCTYPE="multipart/form-data" method="POST" action="<c:url value='register.do' />"  id="register.do" >
      ...
      <input type="text" name="Serialnumber" value="${param.Serialnumber}" class="fieldWidth" style="width: 200px;">

      <font color="red" size="-1">${MsgMap.errorSerialnumber}${MsgMap.errorIDDup}</font>
      <br/>
      <label class="fontSize" >縣市：</label>
      <input type="text" name="County" value="${param.County}" class="fieldWidth" style="width: 200px;">
      <font color="red" size="-1">${MsgMap.errorCounty}</font>      
      <br/>
      
      <label class="fontSize" >職業類別：</label>
      <input type="text" name="Industry" value="${param.Industry}"   class="fieldWidth" style="width: 200px;">
      <font color="red" size="-1">${MsgMap.errorIndustry}</font>            
      <br/>
      
      <label class="fontSize" >受傷原因：</label>
      <input type="text" name="Intermedia" value="${param.Intermedia}"  class="fieldWidth" style="width: 200px;">
      <font color="red" size="-1">${MsgMap.errorIntermedia}</font>
      <br/>
      
      <label class="fontSize" >受傷類別：</label>
      <input type="text"  name="Disaster" value="${param.Disaster}"    class="fieldWidth" style="width: 200px;">
      
      <font color="red" size="-1">${MsgMap.errorDisaster}</font>
      <br/>
      
      <label class="fontSize" >日期：</label>
          <input type="text"  name="Date" value="${param.Date}"   class="fieldWidth" style="width: 200px;">
          <span>(yyyy-MM-dd)</span>
          <font color="red" size="-1">${MsgMap.errorDate}</font>
      <br/>
      
     <label class="fontSize" >死亡數：</label>
      <input type="text"  name="Dead" value="${param.Dead}"    class="fieldWidth" style="width: 200px;">
      <font color="red" size="-1">${MsgMap.errorDead}</font>
      <br/>
      
      <label class="fontSize" >受傷數：</label>
      <input type="text"  name="Hurt" value="${param.Dead}"    class="fieldWidth" style="width: 200px;">
