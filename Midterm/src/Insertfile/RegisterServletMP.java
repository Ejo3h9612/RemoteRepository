...
@WebServlet("/Insertfile/register.do")
public class RegisterServletMP extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			// 2.若無問題，儲存會員的資料
			MemberDaoImpl_Jdbc service = new MemberDaoImpl_Jdbc();
			if (service.idExists(serialnumber)) {
				errorMsg.put("errorIDDup", "此編號已存在，請換新編號");
			} else {
